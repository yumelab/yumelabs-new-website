...
const Service = (props:Props) =>{
    ...
    return(
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white place-items-end md:min-w-[60%] min-w-full p-2 rounded-md shadow-sm h-50"> 
                ...
                <div className="col-span-1 md:aspect-square aspect-video h-full md:block">
                    <Image
                        alt={image}
