...
const Innovation = () => {
  return (
    <section className="flex flex-nowrap gap-4 md:py-32 py-16 overflow-hidden">
        <div className="bg-gray-50 p-16">A</div>
        <div className="bg-gray-50 p-16">B</div>
        <div className="bg-gray-50 p-16">C</div>
        <div className="bg-gray-50 p-16">D</div>
      {/* <div className="w-full md:w-1/3 bg-gray-100 p-9 rounded-lg flex flex-col gap-24">
      ...
      <div className="w-[600] md:flex-1 bg-gray-100 px-8 py-16 rounded-lg overflow-hidden relative">
      ...
      <div className="w-full md:flex-1 bg-gray-100 px-8 py-16 rounded-lg overflow-hidden relative">
