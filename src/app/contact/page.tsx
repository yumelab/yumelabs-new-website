...
const Contact = () =>{
    ...
    return(
        <main className="container md:max-w-screen-xl mx-auto py-32 px-8 md:px-0 flex flex-col gap-8 md:gap-0">
                    ...
                    <div className="relative w-full md:h-full h-72">
                        <div  className="absolute top-0 left-0 rounded-full w-full h-full z-20 animate-spin-slow">
                            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="h-full w-full rounded-full">
                                <path id="circlePath" fill="none" stroke-width="0" d="
                                    M 10, 50
                                    a 40,40 0 1,1 80,0
                                    a 40,40 0 1,1 -80,0
                                    " />
                        ...
                        <div className="absolute w-full h-full aspect-square p-10 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 rounded-full overflow-hidden z-10">
                            <Image
